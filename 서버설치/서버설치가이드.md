...
#### 7-5. mqtt test
```less
mosquitto_pub -h 175.211.153.28 -t test/topic -m "Hello MQTT!" (됨)

mosquitto_pub -h 175.211.153.28 -p 1883 -t test/topic -m "Hello MQTT!" -u hizib -P wikibox

mosquitto_sub -h 175.211.153.28 -t test/topic -u hizib -P wikibox

mosquitto_sub -h 175.211.153.28 -t test/topic (됨)

allow_anonymous true 설정
```
