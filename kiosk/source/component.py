# /home/pi/www/python/elcsoft/component.py
...
class Component(object):
	...
	def joinProcess(self):
		...
		url = 'https://api.hizib.watchbook.tv/%s' % (self.__class__.__name__)
	...
	def downloadProcess(self, **kwargs):
		...
		url = 'https://api.hizib.watchbook.tv/%s/%s' % (self.__class__.__name__, self.__pkValue__)
	...
	def updateProcess(self, **kwargs):
		...
		url = 'https://api.hizib.wikibox.kr/%s/%s' % (self.__class__.__name__, self.__pkValue__)
		#print(url)
		#print(self.toJson())
