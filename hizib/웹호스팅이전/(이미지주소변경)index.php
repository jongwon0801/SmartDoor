...
<div id="fullpage">
  <section class="section page01" id="section0" style="position: relative; overflow: hidden;">
  <!-- 배경 이미지 -->
  <img src="/img/box01_bg.png" alt="background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: 0;">

  <!-- 실제 콘텐츠 -->
  <div class="vid-info container" style="position: relative; z-index: 1;">
    <p data-aos="fade-right" data-aos-duration="1500">
      현명한 <b>집사</b><br>
      든든한 <b>문지기</b><br>
      <img src="/img/box01_text.png" alt="wise monster" id="sl_logo">
  ...
  <section class="section page02 mob_page0" id="section1">
        ...
        <div class="page02_text">
          ...
          얼굴 인식, 사람감지센서 등 부착</p>
        <ul>
          <li><span class="img"><img src="/img/box02_icon01.png" alt="날씨/대기정보"></span>
            <p>날씨/대기정보</p></li>
          <li><span class="img"><img src="/img/box02_icon02.png" alt="시간/달력"></span><p>시간/달력</p></li>
          <li><span class="img"><img src="/img/box02_icon03.png" alt="실시간 모니터링"></span><p>실시간 모니터링</p></li>
          <li><span class="img"><img src="/img/box02_icon04.png" alt="커뮤니케이션"></span><p>커뮤니케이션</p></li>
          <li><span class="img"><img src="/img/box02_icon05.png" alt="소지품 알림"></span><p>소지품 알림</p></li>
          <li><span class="img"><img src="/img/box02_icon06.png" alt="얼굴 인식"></span><p>얼굴 인식</p></li>
          <li><span class="img"><img src="/img/box02_icon07.png" alt="홈 조명 제어"></span><p>홈 조명 제어</p></li>
          <li><span class="img"><img src="/img/box02_icon08.png" alt="출입 기록 열람"></span><p>출입 기록 열람</p></li>
          <li><span class="img"><img src="/img/box02_icon09.png" alt="게스트 키 생성"></span><p>게스트 키 생성</p></li>
          <li><span class="img"><img src="/img/box02_icon10.png" alt="도어락 원격 제어"></span><p>도어락 원격 제어</p></li>
        </ul>
        </div>
  ...
  <section class="section page03 mob_page1" id="section2">
    <div class="page_text">
      ...
      <li class="in">
        <ul class="door_icon">
          <li>
            <span class="img"><img src="/img/box03_in01.png" alt="터치 디스플레이"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>터치 디스플레이</h3>
              <p>거울 내 대형 터치<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_in02.png" alt="얼굴인식"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>얼굴인식</h3>
              <p>인공지능 카메라로<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_in03.png" alt="전면 거울"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>전면 거울</h3>
          ...
          <li>
            <span class="img"><img src="/img/box03_in04.png" alt="날씨,대기정보"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>날씨,대기정보</h3>
              <p>외출 전 날씨 및 예보,<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_in05.png" alt="가족 소통"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>가족 소통</h3>
              <p>등록된 가족 구성원에게<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_in06.png" alt="홈 IOT"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>홈 IOT</h3>
              <p>조명, 가스 벨브, 엘리베이터<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_in07.png" alt="캘린더"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>캘린더</h3>
        ...
        <img src="/img/box03_in_door.png" alt="" class="door_img">
      </li>
      <li class="out">
        <ul class="door_icon">
          <li>
            <span class="img"><img src="/img/box03_out01.png" alt="방범모드"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>방범모드</h3>
              <p>외출 시 설정하면<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_out02.png" alt="게스트키 생성"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>게스트키 생성</h3>
              <p>외부인에게 임시로<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_out03.png" alt="스마트 벨"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>스마트 벨</h3>
              <p>벨이 울리면 외부에서도<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_out04.png" alt="원격 제어"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>원격 제어</h3>
              <p>외부에서 원격으로 잠금 해제</p>
          ...
          <li>
            <span class="img"><img src="/img/box03_out05.png" alt="외부 감시"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>외부 감시</h3>
              <p>디스플레이 및 APP내에서<br>
          ...
          <li>
            <span class="img"><img src="/img/box03_out06.png" alt="출입 기록"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>출입 기록</h3>
          ...
          <li>
            <span class="img"><img src="/img/box03_out07.png" alt="예비 전력"></span>
            <span class="middle"></span>
            <div class="text">
              <h3>예비 전력</h3>
        ...
        <img src="/img/box03_out_door.png" alt="" class="door_img">
      </li>
    </ul>
  ...
  <section class="section page04 mob_page2" id="section3">
        ...
        <img src="/img/box04_phone.png" alt="">
  ...
  <section class="section page05 mob_page3" id="section4">
    	<div class="page_text container" data-aos="fade-up" data-aos-duration="800">
          <div class="cont_box">
            <span class="img"><img src="/img/box05_01.png" alt=""></span>
            <span class="middle"></span>
            <div class="text">
                <h2>01</h2>
          ...
          <div class="cont_box">
            <span class="img"><img src="/img/box05_02.png" alt=""></span>
            <span class="middle"></span>
            <div class="text">
              <h2>02</h2>
            <h3>외출 후</h3>
          ...
          <div class="cont_box">
            <span class="img"><img src="/img/box05_03.png" alt=""></span>
            <span class="middle"></span>
            <div class="text">
              <h2>03</h2>
            <h3>보안</h3>
          ...
          <div class="cont_box">
            <span class="img"><img src="/img/box05_04.png" alt=""></span>
            <span class="middle"></span>
            <div class="text">
              <h2>04</h2>
            <h3>가족간 소통</h3>
          ...
          <div class="cont_box">
            <span class="img"><img src="/img/box05_05.png" alt=""></span>
            <span class="middle"></span>
            <div class="text">
              <h2>05</h2>
  ...
  <section class="section page08 mob_page5" id="section8">
      <div class="page_text container" data-aos="fade-up" data-aos-duration="800">
        <div class="tech">
          <h2><img src="/img/box08_tit.png" alt="보유기술"></h2>
          <div>
            <img src="/img/box08_tech01.png" alt="영상 통신 기술">
            <h3><i class="fas fa-caret-right"></i> 영상 통신 기술</h3>
            <p>별도의 통신장비 없이 인터넷을 통해 도어와<br>
              모바일 APP간의 안정적인 영상 통화 구현 기술 보유</p>
          </div>
          <div>
            <img src="/img/box08_tech02.png" alt="음파 통신 기술">
          ...
          <div>
            <img src="/img/box08_tech03.png" alt="임베디드 스마트 시스템 구축">
  ...
  <section class="section page09 mob_page6" id="section8">
      <div class="page_text container">
        <div class="cert">
          ...
          <ul>
            <li>
              <img src="/img/box08_cert.png" alt="" style="border:solid 1px #ccc">
              <p>제 10-2150642호<br>무선충전을 이용한 스마트 도어 시스템</p>
            </li>
            <li>
              <img src="/img/box08_cert02.png" alt="" style="border:solid 1px #ccc">
        ...
        <div class="cert" style="margin-bottom:0">
          <h2>인증</h2>
          <ul>
            <li><img src="/img/box08_cert03.png" alt="" style="border:solid 1px #ccc"><p>KC 인증서</p></li>
            <li><img src="/img/box08_cert04.png" alt="" style="border:solid 1px #ccc"><p>방화문 시험성적서</p></li>
            <li><img src="/img/box08_cert05.png" alt="" style="border:solid 1px #ccc"><p>방화문 시험성적서</p></li>
          </ul>
        </div>
      </div>
  </section>
  ...
  <section class="section page10 mob_page7" id="section9">
    <div class="cata">
      <img src="/img/logo_w.png" alt="wise monster">
      <a href="/data/cata.pdf" target="_blank">카탈로그</a>
    </div>
  	<div class="page_text">
      <div class="container">
        <div id="contact_left">
