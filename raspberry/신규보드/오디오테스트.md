...
# usb 오디오 되는 거
paplay --device=alsa_output.usb-C-Media_Electronics_Inc._USB_Audio_Device-00.analog-stereo /home/pi/www/sound/bell.wav
...
# usb 오디오 상세정보 출력
udevadm info -a -n /dev/snd/by-id/usb-C-Media_Electronics_Inc._USB_Audio_Device-00
```
...
# 안되는 거
cvlc --play-and-exit /home/pi/www/sound/bell.wav --aout=alsa --alsa-audio-device=plughw:4,0

# 별도의 오디오 장치 지정 없이 기본 ALSA/PulseAudio 설정을 따른다
cvlc --play-and-exit /home/pi/www/sound/bell.wav

# 도어락 외측 스피커 벨 출력 (소리나는거)
cvlc --play-and-exit /home/pi/www/sound/bell.wav --alsa-audio-device iec958:CARD=Device,DEV=0 --aout=alsa
```
